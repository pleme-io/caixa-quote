  ...
  internal = rec {
    ...
    crates = {
      ...
      "quote-benchmark" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./benches; };
        procMacro = true;
        libName = "quote_benchmark";
        libPath = "lib.rs";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
